# E2E Visual Editor Flows

## Purpose

E2E test coverage for the visual editor (left panel): type selection, inline editing, key rename, delete, expand/collapse, palette drag-and-drop, and node reorder.
