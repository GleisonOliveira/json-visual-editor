...
Performance optimization for CodeMirror editor instances: memoized extensions arrays, memoized JSON serialization, and referentially stable drop zone handlers.
